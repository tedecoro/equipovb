  ...
  const items = [
    {
      ...
      desc: 'Un gestor asignado para cada consorcio'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      desc: 'Información clara, reportes mensuales y rendición de cuentas'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      desc: 'Portal digital 24/7 para ver expensas y administración'
    }
  ];
